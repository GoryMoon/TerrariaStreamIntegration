...
namespace TerrariaStreamIntegration
{
    public class DeathCounter
    {
        ...
        public void Load()
        {
            MyModServer.Log.Debug("Reading death counter");
            if (File.Exists(FileName))
            {
                ...
                {
                    MyModServer.Log.Error(e, "Error reading death counter");
                }
            }
            
            if (_deathCount == null)
            {
                MyModServer.Log.Debug("Creating new death counter");
        ...
        public void Save()
        {
            MyModServer.Log.Debug("Saving death counter");
            try
            {
            ...
            {
                MyModServer.Log.Error(e, "Error saving death counter");
            }
            MyModServer.Log.Debug("Saved death counter");
        }
    }
}